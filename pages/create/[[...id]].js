        ...
        <div className="products_manager">
            ...
            <form className="row" onSubmit={handleSubmit}>
                <div className="col-md-6">
                    ...
                    placeholder="Product ID" className="d-block my-4 w-100 p-2" onChange={handleChangeInput} /> */}

                    <input type="text" name="title" value={title}
                    placeholder="Title" className="d-block my-4 w-100 p-2" onChange={handleChangeInput} />
                    ...
                    <textarea name="description" id="description" cols="30" rows="3.9"
